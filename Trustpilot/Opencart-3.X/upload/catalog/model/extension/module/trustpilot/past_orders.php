...
class ModelExtensionModuleTrustpilotPastOrders extends Model {
    ...
    private function getInvitations($orders, $collect_product_data) {
        ...
        foreach ($orders as $order) {
            $invitation = $this->model_extension_module_trustpilot_invitation->getInvitation($order, $collect_product_data, 'past-orders');
